...
public class DeletRecordB {
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("_____________________________Result Before Delete________________________________\n");
            while(rs.next()){
            ...
            stmt.execute("Delete from javaCourseNew where Marks < 70");

            stmt.execute("Select * from javaCourseNew");
            rs = stmt.getResultSet();
            System.out.println("____________________________Result After Delete___________________________________\n");
            while(rs.next()){
                RollString = rs.getString("Roll");
                NameString = rs.getString("Name");
                MarksString = rs.getString("Marks");
